...
const NFTTemplate = ({ name, backgroundImage, isNormalised }: Props) => {
  ...
  return (
    <svg viewBox="0 0 270 270" display="block" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* ECNS Diamond Prism Mark — 8-face geometric prism */}
      <g transform="translate(33,31) scale(0.5)" filter="url(#dropShadow)">
        {/* Base silhouette */}
        <polygon points="40,2 70,50 40,98 10,50" fill="#0D3D2E" />
        {/* Left faces (bright — light-catching side) */}
      ...
      <defs>
        ...
        >
          <stop stopColor="#0D3D2E" />
          <stop offset="0.592" stopColor="#3FB68B" />
          <stop offset="1" stopColor="#4FD4A4" />
        </linearGradient>
        <linearGradient
          id="paint1_linear"
          x1="0"
