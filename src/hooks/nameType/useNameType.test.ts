...
describe('useNameType', () => {
  describe('name level', () => {
    ...
    it('should return 2ld', async () => {
      ...
      const { result } = renderHook(() => useNameType(testDomain('test')))
  ...
  describe('wrap level', () => {
    ...
    it('should return unwrapped subname', async () => {
      ...
      const { result } = renderHook(() => useNameType(testSub('sub', 'test')))
    ...
    it('should return for grace period unwrapped', async () => {
      ...
      const { result } = renderHook(() => useNameType(testDomain('name')))
