...
import { checkDNS2LDFromName, checkNativeTld2LD, checkSubname } from '@app/utils/utils'
...
export const getSendAbilities = ({
  ...
  if (checkNativeTld2LD(name)) return get2LDEthAbilities({ address, basicNameData })
